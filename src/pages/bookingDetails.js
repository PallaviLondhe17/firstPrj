  ...
  return (
    <>
      <Box sx={{ width: 350, ml: 60, alignItems: "center" }}>
        <Typography sx={{ ml: 10, mt: 3, fontSize: 20, fontWeight: "regular" }}>
          Booking Details
        </Typography>
      </Box>
      <Box sx={{ mt: 3, ml: 55, width: 500, border: "1px solid grey" }}>
        <Box component="ul" sx={{ display: "fixed" }}>
          <Item sx={{ mt: 1 }}>
            <FileCopySharp />
          </Item>
          <Item sx={{ ml: 1, mt: 1 }}>
        ...
        <Box component="li" sx={{ display: "flex" }}>
          ...
          <Item>Dr. Name</Item>
          <Item sx={{ flexGrow: 1, ml: 30, textAlign: "right" }}>
            Akshay Kumar
          </Item>
        </Box>
        <Box component="li" sx={{ display: "flex" }}>
          ...
          <Item sx={{ textAlign: "right", flexGrow: 1, ml: 20 }}>
            Animal astro
          </Item>
        </Box>
        <Box component="li" sx={{ display: "flex" }}>
