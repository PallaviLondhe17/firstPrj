  ...
  return (
    <>
      ...
      >
        ...
        <Box sx={{ width: 350, ml: 10, alignItems: "center" }}>
          {" "}
          <Typography
            sx={{ ml: 10, mt: 3, fontSize: 20, fontWeight: "regular" }}
          >
      ...
      <Box sx={{ mt: 3, ml: 60, width: 500, border: "1px solid grey" }}>
        <Box sx={{ display: "fixed" }}>
          ...
          <Item sx={{ ml: 1, mt: 1 }}>Reason for Visit :</Item>
          <Item sx={{ display: "flex", ml: 3 }}>
            <TextField />
          </Item>
        </Box>
        <Divider />
        <Box sx={{ mt: 1, ml: 10, mb: 1, display: "flex" }} gap={20}>
          <Button
            size="small"
            color="error"
            variant="contained"
